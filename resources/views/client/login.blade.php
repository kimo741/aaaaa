    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('do.login') }}" @submit.prevent="$root.onSubmit">
                    ...
                    <div class="row">
                        <a class="col-md-5" href="{{ route('admin.forgot_password.create') }}">{{ __('admin::app.sessions.login.forgot-password') }}</a>
                        <a class="col-md-5" href="{{ route('get.register') }}"> Don't Have Account 🤔</a>
                    </div>
